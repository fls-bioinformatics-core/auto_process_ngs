...
docs.generate_fq_protocols_for_apps(os.path.join(auto_content_dir,
...
docs.generate_applications_table(os.path.join(auto_content_dir,
                                              "10x_single_cell_apps.rst"),
                                 tags=["10x", "single_cell", "!legacy"])
...
docs.ExampleQCPlots.read_counts(imagesdir)
docs.ExampleQCPlots.sequence_lengths(imagesdir)
docs.ExampleQCPlots.sequence_duplication(imagesdir)
docs.ExampleQCPlots.adapter_content(imagesdir)
docs.ExampleQCPlots.picard_insert_sizes(imagesdir)
docs.ExampleQCPlots.qualimap(imagesdir)
