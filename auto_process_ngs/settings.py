        ...
        GenericSettings.__init__(
            ...
            settings = {
                ...
                "qc": { "nprocessors": int,
                        ...
                        "shorten_zip_paths": bool,
                        "use_legacy_screen_names": bool },
                "screen:*": { "conf_file": str },
                "organism:*": { "star_index": path,
                                "bowtie_index": path,
                                "cellranger_reference": path,
                                "annotation_bed": path,
                                "annotation_gtf": path,
                                "cellranger_premrna_reference": path,
                                "cellranger_atac_reference": path,
                                "cellranger_arc_reference": path,
                                "cellranger_probe_set": path },
