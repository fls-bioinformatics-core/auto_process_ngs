...
class TestQCPipelineCellrangerCount(BaseQCPipelineTestCase):
    ...
    def test_qcpipeline_qc_modules_cellranger_count_scrnaseq_10_0_0(self):
        """
        QCPipeline: 'cellranger_count' QC module (scRNA-seq, Cellranger v10.0.0)
        """
        # Make mock QC executables
        MockCellrangerExe.create(os.path.join(self.bin,"cellranger"),
                                 version="10.0.0",
    ...
    def test_qcpipeline_qc_modules_cellranger_count_snrnaseq_10_0_0(self):
        """
        QCPipeline: 'cellranger_count' QC module (snRNA-seq, Cellranger v10.0.0)
        """
        # Make mock QC executables
        MockCellrangerExe.create(os.path.join(self.bin,"cellranger"),
                                 version="10.0.0",
