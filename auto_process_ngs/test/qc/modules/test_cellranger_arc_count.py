...
class TestQCPipelineCellrangerArcCount(BaseQCPipelineTestCase):
    ...
    def test_qcpipeline_qc_modules_cellranger_arc_count_multiome_snatac_200(self):
        """
        QCPipeline: 'cellranger-arc_count' QC module (SC multiome snATAC, Cellranger-ARC 2.0.0)
        """
        # Make mock QC executables
        MockCellrangerExe.create(os.path.join(self.bin,"cellranger-arc"),
                                 version="2.0.0")
    ...
    def test_qcpipeline_qc_modules_cellranger_arc_count_multiome_sngex_200(self):
        """
        QCPipeline: 'cellranger-arc_count' QC module (SC multiome snGEX, Cellranger-ARC 2.0.0)
        """
        # Make mock QC executables
        MockCellrangerExe.create(os.path.join(self.bin,"cellranger-arc"),
                                 version="2.0.0")
