...
class TestReportFunction(unittest.TestCase):
    ...
    def _make_analysis_project(self,name="PJB",
        ...
        qc_dir = os.path.join(self.top_dir,self.analysis_dir.name,qc_dir)
        ...
        return os.path.join(self.top_dir,self.analysis_dir.name)
    ...
    def _make_qc_dir(self,qc_dir,fastq_names,
        ...
        if include_cellranger_multi:
            ...
            with open(multi_config,'wt') as fp:
                fastq_dir = os.path.join(self.top_dir,
                                         "PJB",
                                         "fastqs")
