...
def add_make_fastqs_command(cmdparser):
    ...
    # ICELL8 options
    icell8 = optparse.OptionGroup(p,'ICELL8 options (ICELL8 data only)')
    icell8.add_option("--well-list",
                      dest="icell8_well_list",
                      default=None,
                      help="specify ICELL8 well list file")
    icell8.add_option('--swap-i1-and-i2',
                      action='store_true',
                      dest="icell8_swap_i1_and_i2",
                      help="swap supplied I1 and I2 Fastqs when matching "
                      "ATAC barcodes against well list")
    icell8.add_option('--reverse-complement',type='choice',
                      choices=['i1','i2','both'],
        ...
        if cmd == 'make_fastqs':
            ...
            try:
                d.make_fastqs(
                    ...
                    lanes=lanes,
                    icell8_well_list=options.icell8_well_list,
                    icell8_swap_i1_and_i2=options.icell8_swap_i1_and_i2,
                    icell8_reverse_complement=options.icell8_reverse_complement,
